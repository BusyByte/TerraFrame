...
object BlockType {
  ...
  lazy val blockTools: Map[BlockType, Set[UiItem]] = {
    ...
    val l1ToolSet = Set[UiItem](CopperPickUiItem, IronPickUiItem, SilverPickUiItem, GoldPickUiItem, ZincPickUiItem, RhymestonePickUiItem, ObduritePickUiItem, AluminumPickUiItem, LeadPickUiItem, WoodenPickUiItem, StonePickUiItem, MagnetitePickUiItem, IrradiumPickUiItem)
    val l2ToolSet = Set[UiItem](CopperAxeUiItem, IronAxeUiItem, SilverAxeUiItem, GoldAxeUiItem, ZincAxeUiItem, RhymestoneAxeUiItem, ObduriteAxeUiItem, AluminumAxeUiItem, LeadAxeUiItem, WoodenAxeUiItem, StoneAxeUiItem, MagnetiteAxeUiItem, IrradiumAxeUiItem)
    val l3ToolSet = Set[UiItem](CopperPickUiItem, IronPickUiItem, SilverPickUiItem, GoldPickUiItem, CopperAxeUiItem, IronAxeUiItem, SilverAxeUiItem, GoldAxeUiItem, ZincPickUiItem, ZincAxeUiItem, RhymestonePickUiItem, RhymestoneAxeUiItem, ObduritePickUiItem, ObduriteAxeUiItem, AluminumPickUiItem, AluminumAxeUiItem, LeadPickUiItem, LeadAxeUiItem, WoodenPickUiItem, WoodenAxeUiItem, StonePickUiItem, StoneAxeUiItem, MagnetitePickUiItem, MagnetiteAxeUiItem, IrradiumPickUiItem, IrradiumAxeUiItem)
    val l4ToolSet = Set[UiItem](CopperPickUiItem, IronPickUiItem, SilverPickUiItem, GoldPickUiItem, ZincPickUiItem, RhymestonePickUiItem, ObduritePickUiItem, AluminumPickUiItem, LeadPickUiItem, WoodenPickUiItem, StonePickUiItem)
    val l5ToolSet = Set[UiItem](CopperPickUiItem, IronPickUiItem, SilverPickUiItem, GoldPickUiItem, CopperAxeUiItem, IronAxeUiItem, SilverAxeUiItem, GoldAxeUiItem, ZincPickUiItem, ZincAxeUiItem, RhymestonePickUiItem, RhymestoneAxeUiItem, ObduritePickUiItem, ObduriteAxeUiItem)
