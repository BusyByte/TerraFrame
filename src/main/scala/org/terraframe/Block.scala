...
case object Block extends IntEnum[Block] {
  ...
  case object ZythiumDelayer1DelayRightBlock   extends Block(137)
  case object ZythiumDelayer1DelayDownBlock    extends Block(138)
  case object ZythiumDelayer1DelayLeftBlock    extends Block(139)
  case object ZythiumDelayer1DelayUpBlock      extends Block(140)
  case object ZythiumDelayer1DelayRightOnBlock extends Block(141)
  case object ZythiumDelayer1DelayDownOnBlock  extends Block(142)
  case object ZythiumDelayer1DelayLeftOnBlock  extends Block(143)
  case object ZythiumDelayer1DelayUpOnBlock    extends Block(144)
  case object ZythiumDelayer2DelayRightBlock   extends Block(145)
  case object ZythiumDelayer2DelayDownBlock    extends Block(146)
  case object ZythiumDelayer2DelayLeftBlock    extends Block(147)
  case object ZythiumDelayer2DelayUpBlock      extends Block(148)
  case object ZythiumDelayer2DelayRightOnBlock extends Block(149)
  case object ZythiumDelayer2DelayDownOnBlock  extends Block(150)
  case object ZythiumDelayer2DelayLeftOnBlock  extends Block(151)
  case object ZythiumDelayer2DelayUpOnBlock    extends Block(152)
  case object ZythiumDelayer4DelayRightBlock   extends Block(153)
  case object ZythiumDelayer4DelayDownBlock    extends Block(154)
  case object ZythiumDelayer4DelayLeftBlock    extends Block(155)
  case object ZythiumDelayer4DelayUpBlock      extends Block(156)
  case object ZythiumDelayer4DelayRightOnBlock extends Block(157)
  case object ZythiumDelayer4DelayDownOnBlock  extends Block(158)
  case object ZythiumDelayer4DelayLeftOnBlock  extends Block(159)
  case object ZythiumDelayer4DelayUpOnBlock    extends Block(160)
  case object ZythiumDelayer8DelayRightBlock   extends Block(161)
  case object ZythiumDelayer8DelayDownBlock    extends Block(162)
  case object ZythiumDelayer8DelayLeftBlock    extends Block(163)
  case object ZythiumDelayer8DelayUpBlock      extends Block(164)
  case object ZythiumDelayer8DelayRightOnBlock extends Block(165)
  case object ZythiumDelayer8DelayDownOnBlock  extends Block(166)
  case object ZythiumDelayer8DelayLeftOnBlock  extends Block(167)
  case object ZythiumDelayer8DelayUpOnBlock    extends Block(168)
  ...
  def drop(block: Block): Option[UiItem] = block match {
    ...
    case ZythiumDelayer1DelayRightBlock   => Some(ZythiumDelayer1UiItem)
    case ZythiumDelayer1DelayDownBlock    => Some(ZythiumDelayer1UiItem)
    case ZythiumDelayer1DelayLeftBlock    => Some(ZythiumDelayer1UiItem)
    case ZythiumDelayer1DelayUpBlock      => Some(ZythiumDelayer1UiItem)
    case ZythiumDelayer1DelayRightOnBlock => Some(ZythiumDelayer1UiItem)
    case ZythiumDelayer1DelayDownOnBlock  => Some(ZythiumDelayer1UiItem)
    case ZythiumDelayer1DelayLeftOnBlock  => Some(ZythiumDelayer1UiItem)
    case ZythiumDelayer1DelayUpOnBlock    => Some(ZythiumDelayer1UiItem)
    case ZythiumDelayer2DelayRightBlock   => Some(ZythiumDelayer2UiItem)
    case ZythiumDelayer2DelayDownBlock    => Some(ZythiumDelayer2UiItem)
    case ZythiumDelayer2DelayLeftBlock    => Some(ZythiumDelayer2UiItem)
    case ZythiumDelayer2DelayUpBlock      => Some(ZythiumDelayer2UiItem)
    case ZythiumDelayer2DelayRightOnBlock => Some(ZythiumDelayer2UiItem)
    case ZythiumDelayer2DelayDownOnBlock  => Some(ZythiumDelayer2UiItem)
    case ZythiumDelayer2DelayLeftOnBlock  => Some(ZythiumDelayer2UiItem)
    case ZythiumDelayer2DelayUpOnBlock    => Some(ZythiumDelayer2UiItem)
    case ZythiumDelayer4DelayRightBlock   => Some(ZythiumDelayer4UiItem)
    case ZythiumDelayer4DelayDownBlock    => Some(ZythiumDelayer4UiItem)
    case ZythiumDelayer4DelayLeftBlock    => Some(ZythiumDelayer4UiItem)
    case ZythiumDelayer4DelayUpBlock      => Some(ZythiumDelayer4UiItem)
    case ZythiumDelayer4DelayRightOnBlock => Some(ZythiumDelayer4UiItem)
    case ZythiumDelayer4DelayDownOnBlock  => Some(ZythiumDelayer4UiItem)
    case ZythiumDelayer4DelayLeftOnBlock  => Some(ZythiumDelayer4UiItem)
    case ZythiumDelayer4DelayUpOnBlock    => Some(ZythiumDelayer4UiItem)
    case ZythiumDelayer8DelayRightBlock   => Some(ZythiumDelayer8UiItem)
    case ZythiumDelayer8DelayDownBlock    => Some(ZythiumDelayer8UiItem)
    case ZythiumDelayer8DelayLeftBlock    => Some(ZythiumDelayer8UiItem)
    case ZythiumDelayer8DelayUpBlock      => Some(ZythiumDelayer8UiItem)
    case ZythiumDelayer8DelayRightOnBlock => Some(ZythiumDelayer8UiItem)
    case ZythiumDelayer8DelayDownOnBlock  => Some(ZythiumDelayer8UiItem)
    case ZythiumDelayer8DelayLeftOnBlock  => Some(ZythiumDelayer8UiItem)
    case ZythiumDelayer8DelayUpOnBlock    => Some(ZythiumDelayer8UiItem)
    case _                                => None
  }
  ...
  lazy val blockTools: Map[Block, Set[UiItem]] = {
    ...
    List[(Block, Set[UiItem])](
      ...
      ZythiumDelayer1DelayRightBlock   -> l1ToolSet,
      ZythiumDelayer1DelayDownBlock    -> l1ToolSet,
      ZythiumDelayer1DelayLeftBlock    -> l1ToolSet,
      ZythiumDelayer1DelayUpBlock      -> l1ToolSet,
      ZythiumDelayer1DelayRightOnBlock -> l1ToolSet,
      ZythiumDelayer1DelayDownOnBlock  -> l1ToolSet,
      ZythiumDelayer1DelayLeftOnBlock  -> l1ToolSet,
      ZythiumDelayer1DelayUpOnBlock    -> l1ToolSet,
      ZythiumDelayer2DelayRightBlock   -> l1ToolSet,
      ZythiumDelayer2DelayDownBlock    -> l1ToolSet,
      ZythiumDelayer2DelayLeftBlock    -> l1ToolSet,
      ZythiumDelayer2DelayUpBlock      -> l1ToolSet,
      ZythiumDelayer2DelayRightOnBlock -> l1ToolSet,
      ZythiumDelayer2DelayDownOnBlock  -> l1ToolSet,
      ZythiumDelayer2DelayLeftOnBlock  -> l1ToolSet,
      ZythiumDelayer2DelayUpOnBlock    -> l1ToolSet,
      ZythiumDelayer4DelayRightBlock   -> l1ToolSet,
      ZythiumDelayer4DelayDownBlock    -> l1ToolSet,
      ZythiumDelayer4DelayLeftBlock    -> l1ToolSet,
      ZythiumDelayer4DelayUpBlock      -> l1ToolSet,
      ZythiumDelayer4DelayRightOnBlock -> l1ToolSet,
      ZythiumDelayer4DelayDownOnBlock  -> l1ToolSet,
      ZythiumDelayer4DelayLeftOnBlock  -> l1ToolSet,
      ZythiumDelayer4DelayUpOnBlock    -> l1ToolSet,
      ZythiumDelayer8DelayRightBlock   -> l1ToolSet,
      ZythiumDelayer8DelayDownBlock    -> l1ToolSet,
      ZythiumDelayer8DelayLeftBlock    -> l1ToolSet,
      ZythiumDelayer8DelayUpBlock      -> l1ToolSet,
      ZythiumDelayer8DelayRightOnBlock -> l1ToolSet,
      ZythiumDelayer8DelayDownOnBlock  -> l1ToolSet,
      ZythiumDelayer8DelayLeftOnBlock  -> l1ToolSet,
      ZythiumDelayer8DelayUpOnBlock    -> l1ToolSet
    ).toMap
  }
  ...
  def powers(block: Block): Boolean = block match {
    ...
    case StonePressurePlateOnBlock        => true
    case ZythiumPressurePlateOnBlock      => true
    case ZythiumDelayer1DelayRightOnBlock => true
    case ZythiumDelayer1DelayDownOnBlock  => true
    case ZythiumDelayer1DelayLeftOnBlock  => true
    case ZythiumDelayer1DelayUpOnBlock    => true
    case ZythiumDelayer2DelayRightOnBlock => true
    case ZythiumDelayer2DelayDownOnBlock  => true
    case ZythiumDelayer2DelayLeftOnBlock  => true
    case ZythiumDelayer2DelayUpOnBlock    => true
    case ZythiumDelayer4DelayRightOnBlock => true
    case ZythiumDelayer4DelayDownOnBlock  => true
    case ZythiumDelayer4DelayLeftOnBlock  => true
    case ZythiumDelayer4DelayUpOnBlock    => true
    case ZythiumDelayer8DelayRightOnBlock => true
    case ZythiumDelayer8DelayDownOnBlock  => true
    case ZythiumDelayer8DelayLeftOnBlock  => true
    case ZythiumDelayer8DelayUpOnBlock    => true
    case _                                => false
  }
  ...
  def lightIntensity(block: Block): Int = block match {
    ...
    case ZythiumDelayer1DelayRightBlock => 12
    case ZythiumDelayer1DelayDownBlock  => 12
    case ZythiumDelayer1DelayLeftBlock  => 12
    case ZythiumDelayer1DelayUpBlock    => 12
    case ZythiumDelayer2DelayRightBlock => 12
    case ZythiumDelayer2DelayDownBlock  => 12
    case ZythiumDelayer2DelayLeftBlock  => 12
    case ZythiumDelayer2DelayUpBlock    => 12
    case ZythiumDelayer4DelayRightBlock => 12
    case ZythiumDelayer4DelayDownBlock  => 12
    case ZythiumDelayer4DelayLeftBlock  => 12
    case ZythiumDelayer4DelayUpBlock    => 12
    case ZythiumDelayer8DelayRightBlock => 12
    case ZythiumDelayer8DelayDownBlock  => 12
    case ZythiumDelayer8DelayLeftBlock  => 12
    case ZythiumDelayer8DelayUpBlock    => 12
